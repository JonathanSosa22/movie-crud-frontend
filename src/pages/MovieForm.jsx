...
const MovieForm = () => {
  ...
  return (
    <>
      ...
      <GenresModal
        show={showForm.genres}
        handleClose={() => closeForm("genres")}
      />
      <ActorsForm
        show={showForm.actors}
        handleClose={() => closeForm("actors")}
      />
      <DirectorsForm
        show={showForm.directors}
        handleClose={() => closeForm("directors")}
      />
    </>
  );
};
